...
def get_campaigns(
    ...
    campaigns = get_campaigns_service(
        db,
        current_user,
        search,
    )
    ...
    data = [
        ...
        for campaign, role in campaigns
    ]
...
def update(
    ...
    campaign = update_campaign_service(
        db,
        campaign_id,
        current_user,
        data,
...
def list_campaign_members(
    ...
    members = get_campaign_members_service(
        db,
        campaign_id,
        current_user,
    )
