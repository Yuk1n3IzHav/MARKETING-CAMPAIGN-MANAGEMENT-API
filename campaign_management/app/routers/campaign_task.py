...
def create_campaign_task(
    ...
    task = campaign_task_service.create_campaign_task(
        db,
        campaign_id,
        current_user.id,
        task_data,
...
def get_campaign_tasks(
    ...
    tasks = campaign_task_service.get_campaign_tasks(
        db=db,
...
def get_campaign_task(
    ...
    task = campaign_task_service.get_campaign_task(
        db,
        task_id,
        current_user.id,
    )
...
def update_campaign_task(
    ...
    task = campaign_task_service.update_campaign_task(
        db,
        task_id,
        current_user.id,
        task_data,
...
def delete_campaign_task(
    ...
    campaign_task_service.delete_campaign_task(
        db,
        task_id,
        current_user.id,
    )
